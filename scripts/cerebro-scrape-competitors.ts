...
const TARGETS: Target[] = [
  ...
  { url: "https://www.indiehackers.com/post/lessons-from-running-a-print-on-demand-store-2025", category: "pod", why: "Indie operator's lessons" },
  ...
  { url: "https://baymard.com/blog/current-state-ecommerce-product-page-ux", category: "email", why: "Baymard product page UX 2026 — top patterns" },
  { url: "https://baymard.com/blog/mobile-ux-ecommerce", category: "email", why: "Baymard mobile UX 2025 — what wins on phones" },

  // ── Channels (TikTok / Pinterest / SEO / Etsy) ──
  ...
  { url: "https://www.etsy.com/seller-handbook", category: "channels", why: "Etsy Seller Handbook — official channel-of-record for Etsy sellers" },
  ...
  // ── New 2026-05-13: research briefs already-distilled (skip scrape, just ingest) ──
  // These local files were generated by the research agent cluster.
  // They're more dense than raw web scrapes — high signal per token.
  // Files live in .openclaw/research/ — copied to raw/research/ for graphify ingest
];
